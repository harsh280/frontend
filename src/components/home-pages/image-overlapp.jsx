...
const ImageOverlapp = () => {
    return (
        <div className="flex w-full h-full relative">
            ...
            <div className="lg:w-[350px] h-[100px] w-[280px]  bg-white rounded-full absolute lg:left-[150px] left-[5px] top-[200px] flex">
                ...
                <h2 className="text-[#6E0F3C] font-bold lg:text-2xl text-xl text-center mt-[30px] ml-2">easy chicken dinner</h2>
            </div>
        </div>
    )
}
