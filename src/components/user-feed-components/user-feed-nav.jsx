    ...
    return (
        <div className="bg-white w-full h-[13%] fixed shadow-md z-10">
            <div className="w-full h-full inline-flex justify-evenly p-4">
                ...
                <div>
                <button className="bg-black text-white w-[80px] h-[50px] font-bold rounded-full">Home</button>
                </div>
                <div className="lg:flex gap-x-10 hidden">
                <div className="mt-4">
                    <a className = "text-black text-normal font-semibold" href = "#">Explore</a>
                </div>
                <div className="mt-4">
                    <a className = "text-black text-normal font-semibold" href = "#">Create</a>
                </div>
                <div className="flex w-[60%] h-full rounded-full bg-[#E9E9E9] items-center px-4">
                    <svg className="" height="16" width="16" viewBox="0 0 24 24" aria-label="Search icon" role="img"><path d="M10 16c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6m13.12 2.88-4.26-4.26A9.842 9.842 0 0 0 20 10c0-5.52-4.48-10-10-10S0 4.48 0 10s4.48 10 10 10c1.67 0 3.24-.41 4.62-1.14l4.26 4.26a3 3 0 0 0 4.24 0 3 3 0 0 0 0-4.24"></path></svg>
                    <input className="w-[80%] bg-[#E9E9E9]  ml-2 border-none outline-none" placeholder="Search"></input>
                </div>
                </div>
                <div className="mt-4">
                ...
                <div className="mt-2">
                <Link href = "/">
                <button className="bg-red-600 text-white w-[75px] h-[40px] font-bold rounded-full">Log out</button>
                </Link>
                </div>
               </div>
        </div>
